        ...
        <nav id="sidebar">
			...
			<li  class="active">
                ...
                <li class="dropdown">
					...
					<i class="material-icons">aspect_ratio</i>Teachers </a>
                ...
                <li class="dropdown">
					...
					class="dropdown-toggle">
					<i class="material-icons">apps</i><span>Students</span></a>
				 ...
				 <li class="dropdown">
					...
					class="dropdown-toggle">
					<i class="material-icons">Non teaching Stuff </i>
				
					
					<span>chart</span></a>
                    <ul class="collapse list-unstyled menu" id="pageSubmenu3">
                        <li>
                            <a href="#">All non teachin stuff</a>
                        </li>
                        <li>
                            <a href="#">Page 2</a>
                        </li>
