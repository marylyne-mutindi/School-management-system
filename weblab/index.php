...
<div class="wrapper">
	 ...
	 <div id="sidebar">
	    <div class="sidebar-header">
		   <h3><img src="img/logo.png" class="img-fluid"/><span>School Website</span></h3>
		</div>
		<ul class="list-unstyled component m-0">
		  ...
		  <i class="material-icons">aspect_ratio</i>Teaching stuff
		  </a>
		  ...
		  class="dropdown-toggle">
		  <i class="material-icons">apps</i>Student
		  </a>
		  ...
		  class="dropdown-toggle">
		  <i class="material-icons">equalizer</i>Non Teaching Stuff
		  </a>
		  <ul class="collapse list-unstyled menu" id="homeSubmenu3">
		     <li><a href="#">All Non teaching</a></li>
